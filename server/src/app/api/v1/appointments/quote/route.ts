...
export async function POST(request:Request) {
  return handle(async () => {
    ...
    const result=await db.rpc('quote_appointment',{client:body.client_id,practitioner:body.practitioner_id,service_ids:body.service_ids,slot_start:body.starts_at});
