...
import 'package:elmaclinic/presentation/payments/payment_ledger_screen.dart';
...
void main() {
  ...
  testWidgets('ADMIN ledger renders persisted totals and receipts', (
    tester,
  ) async {
    viewport(tester);
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/payment_ledger.png'),
    );
  });
}
