...
import 'website_bookings_test.dart' show FakeWebsite;
...
void main() {
  ...
  testWidgets('Website review queue follows reference cards', (tester) async {
    viewport(tester);
    ...
    await expectLater(
      ...
      matchesGoldenFile('goldens/website_review.png'),
    );
  });
}
